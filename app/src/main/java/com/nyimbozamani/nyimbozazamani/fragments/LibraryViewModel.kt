...
class LibraryViewModel(
    ...
    private val albums = MutableLiveData<List<Song>>()
    ...
    fun getAlbums(): LiveData<List<Song>> {
        return albums
    }
    ...
    private fun fetchSongs() {
        viewModelScope.launch(IO) {
            songs.postValue(repository.songsOnline())
        }
    }

    private fun fetchAlbums() {
        viewModelScope.launch(IO) {
            albums.postValue(repository.allSongs())
        }
    }
