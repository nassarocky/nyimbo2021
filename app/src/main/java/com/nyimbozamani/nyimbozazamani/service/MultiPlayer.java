...
public class MultiPlayer
   ...
   */
  @Override
  public boolean setDataSource(@NonNull final Song path) {
   ...
   * @return True if the <code>player</code> has been prepared and is ready to play, false otherwise
   */
  private boolean setDataSourceImpl(@NonNull final MediaPlayer player, @NonNull final Song song) {

    String url=getTrackUri(Objects.requireNonNull(song));
    if (context == null) {
      return false;
    }
    try {
   ...
   */
  @Override
  public void setNextDataSource(@Nullable final Song path) {
    if (context == null) {
      return;
    }
    try {
