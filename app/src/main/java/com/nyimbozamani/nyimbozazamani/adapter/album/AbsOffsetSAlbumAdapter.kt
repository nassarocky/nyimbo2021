...
abstract class AbsOffsetSAlbumAdapter(
        activity: FragmentActivity,
        dataSet: MutableList<Song>,
        @LayoutRes itemLayoutRes: Int,
        ICabHolder: ICabHolder?
) : AlbumAdapter(activity, dataSet, itemLayoutRes, ICabHolder) {
    ...
    open inner class ViewHolder(itemView: View) : AlbumAdapter.ViewHolder(itemView) {
