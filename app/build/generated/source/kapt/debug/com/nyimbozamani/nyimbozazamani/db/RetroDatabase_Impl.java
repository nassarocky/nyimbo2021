    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(23) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoPlaylistEntity.equals(_existingPlaylistEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "PlaylistEntity(com.nyimbozamani.nyimbozazamani.db.PlaylistEntity).\n"
                  + " Expected:\n" + _infoPlaylistEntity + "\n"
        ...
        if (! _infoSongEntity.equals(_existingSongEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "SongEntity(com.nyimbozamani.nyimbozazamani.db.SongEntity).\n"
                  + " Expected:\n" + _infoSongEntity + "\n"
                  + " Found:\n" + _existingSongEntity);
        }
        ...
        if (! _infoHistoryEntity.equals(_existingHistoryEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "HistoryEntity(com.nyimbozamani.nyimbozazamani.db.HistoryEntity).\n"
                  + " Expected:\n" + _infoHistoryEntity + "\n"
        ...
        if (! _infoPlayCountEntity.equals(_existingPlayCountEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "PlayCountEntity(com.nyimbozamani.nyimbozazamani.db.PlayCountEntity).\n"
        ...
        if (! _infoBlackListStoreEntity.equals(_existingBlackListStoreEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "BlackListStoreEntity(com.nyimbozamani.nyimbozazamani.db.BlackListStoreEntity).\n"
        ...
        if (! _infoLyricsEntity.equals(_existingLyricsEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "LyricsEntity(com.nyimbozamani.nyimbozazamani.db.LyricsEntity).\n"
                  + " Expected:\n" + _infoLyricsEntity + "\n"
