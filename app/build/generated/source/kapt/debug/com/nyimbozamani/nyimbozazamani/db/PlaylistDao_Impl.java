...
public final class PlaylistDao_Impl implements PlaylistDao {
      ...
      public List<PlaylistWithSongs> call() throws Exception {
        ...
        try {
          ...
          try {
            ...
            __fetchRelationshipSongEntityAscomNyimbozamaniNyimbozazamaniDbSongEntity(_collectionSongs);
  ...
  private void __fetchRelationshipSongEntityAscomNyimbozamaniNyimbozazamaniDbSongEntity(final LongSparseArray<ArrayList<SongEntity>> _map) {
    if (_map.isEmpty()) {
      return;
    }
    ...
    if(_map.size() > RoomDatabase.MAX_BIND_PARAMETER_CNT) {
      ...
      while(_mapIndex < _limit) {
        ...
        if(_tmpIndex == RoomDatabase.MAX_BIND_PARAMETER_CNT) {
          __fetchRelationshipSongEntityAscomNyimbozamaniNyimbozazamaniDbSongEntity(_tmpInnerMap);
