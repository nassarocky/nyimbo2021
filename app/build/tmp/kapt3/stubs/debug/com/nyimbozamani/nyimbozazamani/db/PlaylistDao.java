...
public abstract interface PlaylistDao {
    ...
    public abstract java.util.List<com.nyimbozamani.nyimbozazamani.db.PlaylistEntity> isPlaylistExists(@org.jetbrains.annotations.NotNull()
    ...
    java.util.List<com.nyimbozamani.nyimbozazamani.db.SongEntity> songEntities, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> p1);
    ...
    kotlin.coroutines.Continuation<? super java.util.List<com.nyimbozamani.nyimbozazamani.db.SongEntity>> p2);
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM SongEntity WHERE playlist_creator_id = :playlistId")
    public abstract androidx.lifecycle.LiveData<java.util.List<com.nyimbozamani.nyimbozazamani.db.SongEntity>> songsFromPlaylist(long playlistId);
    ...
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM SongEntity WHERE playlist_creator_id= :playlistId")
    public abstract androidx.lifecycle.LiveData<java.util.List<com.nyimbozamani.nyimbozazamani.db.SongEntity>> favoritesSongsLiveData(long playlistId);
    
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM SongEntity WHERE playlist_creator_id= :playlistId")
    public abstract java.util.List<com.nyimbozamani.nyimbozazamani.db.SongEntity> favoritesSongs(long playlistId);
}